...
def test(test_model):
    ...
    print("Before merging dictionary, length is = ", len(gt_img_id))
    
#     gt_img_id[32] = {'license': 3, 'file_name': '00000032.jpg', 'coco_url':                       'http://images.cocodataset.org/val2017/000000394940.jpg', 'height': 360, 'width': 640, 'date_captured': '203213-11-24 13:47:05', 'flickr_url': 'http://farm9.staticflickr.com/8227/8566023505_e9e9f997bc_z.jpg', 'id': 32}
    
    with open ("valimage_dict.json", "r") as input_file:
        add_dict = json.load(input_file)
    
    gt_img_id.update(add_dict)
    print("After mergind dictionary, length is = ", len(gt_img_id))
...
#     print(result)
    ...
    # not evaluating only saving
    result_path = osp.join(cfg.result_dir, 'result.json')
